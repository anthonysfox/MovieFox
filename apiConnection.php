<?php
    ...
    // Getting variables from AJAX request in js/api.js
    ...
    /**
     * Get title from TMDb API based on an option selected in apiForm.php 
     * which is an ID based on genre ids stored in the api 
     */
...
<body>
    <table>
        ...
        <?php 
            for($i = 0; $i < 15; $i++) {
                echo '<tr>';
                echo    '<td>' . $omdb_movie_data[$i][0] . '</td>';
                echo '</tr>';
            } 
        ?>
</body>
